...
/**
    ...
    lwork   INTEGER
            ...
            nb can be obtained through magma_get_zgesvd_nb(N).
    ...
    if (m >= n) {
        ...
        if (m >= mnthr1) {
            if (wantqn) {
                ...
                #else
                magma_zgebrd(n, n, A(1,1), lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
                #endif
                nrwork = ie + n;
                ...
                #else
                magma_zgebrd(n, n, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_zunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, n, n, n, &work[ir], ldwrkr, &work[itauq], &work[iu], ldwrku, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_zunmbr(MagmaP, MagmaRight, MagmaConjTrans, n, n, n, &work[ir], ldwrkr, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_zunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, n, n, n, &work[ir], ldwrkr, &work[itauq], U, ldu, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_zunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, n, n, n, A(1,1), lda, &work[itauq], &work[iu], ldwrku, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_zunmbr(MagmaP, MagmaRight, MagmaConjTrans, n, n, n, A(1,1), lda, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            ...
            #else
            magma_zgebrd(m, n, A(1,1), lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
            #endif
            ...
            if (wantqn) {
                ...
                if (lwork >= m*n + 3*n) {
                    ...
                    #else
                    magma_zunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, m, n, n, A(1,1), lda, &work[itauq], &work[iu], ldwrku, &work[nwork], lnwork, queue, &ierr);
                    #endif
                ...
                #else
                magma_zunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, m, n, n, A(1,1), lda, &work[itauq], U, ldu, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_zunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, m, m, n, A(1,1), lda, &work[itauq], U, ldu, &work[nwork], lnwork, queue, &ierr);
                #endif
        ...
        if (n >= mnthr1) {
            if (wantqn) {
                ...
                #else
                magma_zgebrd(m, m, A(1,1), lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
                #endif
                nrwork = ie + m;
                ...
                #else
                magma_zgebrd(m, m, &work[il], ldwrkl, s, &rwork[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_zunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, m, m, m, &work[il], ldwrkl, &work[itauq], U, ldu, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_zunmbr(MagmaP, MagmaRight, MagmaConjTrans, m, m, m, &work[il], ldwrkl, &work[itaup], &work[ivt], ldwkvt, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_zunmbr(MagmaP, MagmaRight, MagmaConjTrans, m, m, m, &work[il], ldwrkl, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_zunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, m, m, m, A(1,1), lda, &work[itauq], U, ldu, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_zunmbr(MagmaP, MagmaRight, MagmaConjTrans, m, m, m, A(1,1), lda, &work[itaup], &work[ivt], ldwkvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            ...
            if (wantqn) {
                ...
                if (lwork >= m*n + 3*m) {
                    ...
                    #else
                    magma_zunmbr(MagmaP, MagmaRight, MagmaConjTrans, m, n, m, A(1,1), lda, &work[itaup], &work[ivt], ldwkvt, &work[nwork], lnwork, queue, &ierr);
                    #endif
                ...
                #else
                magma_zunmbr(MagmaP, MagmaRight, MagmaConjTrans, m, n, m, A(1,1), lda, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            }
            else {
                /* Path 6ta (N >= M, JOBZ=A) */
                ...
                #else
                magma_zunmbr(MagmaP, MagmaRight, MagmaConjTrans, n, n, m, A(1,1), lda, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            }
        }
    }
